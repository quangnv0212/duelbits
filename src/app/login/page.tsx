      ...
      <div className="grid grid-cols-2 text-white">
        <div className="">
          <div className="flex flex-col gap-2 justify-center">
            ...
            <p className="font-extrabold">REGIONAL</p>
            <p>SPONSOR</p>
            <p>
              By accessing this site I attest that I am at least 18 years old
              and have read and agree with the Terms of Service.
            </p>
          </div>
        </div>
        <div className="flex flex-col gap-2">
          <div className="flex gap-4 items-center">
            {tab.map((item, index) => (
              ...
              >
                <p className="text-xl font-extrabold">{item.label}</p>
              </div>
            ))}
            <p className="flex-1 text-end text-2xl">x</p>
          </div>
          <div className="flex flex-col gap-2">
            ...
            <p className="font-semibold text-center py-5">Forgot password</p>
          </div>
          <p className="text-center px-10 text-[#527490]">
