    ...
    <>
      ...
      <Layout style={{ minHeight: "100vh" }}>
        ...
        >
          ...
          <div className={`${collapsed ? "hidden" : "flex"} justify-between `}>
            <div className="grid grid-cols-2 w-full p-2">
              <button className="flex gap-2 p-2 hover:bg-[#4b5b67] rounded-full items-center ">
                <svg
                  width={16}
                  height={16}
                  viewBox="0 0 15 16"
        ...
        <Layout>
          <Content style={{ padding: "32px 70px", backgroundColor: "#1e2d3b" }}>
            {children}
          </Content>
        </Layout>
      </Layout>
