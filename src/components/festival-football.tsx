  ...
  return (
    <div>
      <div className="flex gap-2 text-white font-bold text-base p-2 items-center">
        ...
        <div className="mb-2">The Festival of Football</div>
      </div>
      <div
        className="flex gap-5 p-3 rounded-md"
        style={{
          backgroundImage:
            "url(	https://duelbits.com/static/media/football-festival-desktop.ae65d85e.avif)",
          backgroundSize: "cover",
        }}
      >
        <div className="w-[454px] flex flex-col gap-3">
          <div className="">
            <span className="border text-white border-white p-1 rounded font-semibold text-xs">
              Friday, May 3 - Friday, Jun 14
            </span>
          </div>
          <div className=" text-white text-2xl font-semibold ">
            <span className="font-semibold text-2xl text-primary">Collect</span>
        ...
        <div className="rounded-md border border-[#527490] flex">
          <div className="grid grid-cols-3 ">
            <div className="bg-[#324B61] py-5 px-7 border-[#293f52] border-2 ">
              <img
          ...
          <div className="flex items-center bg-[#324B61]">
            <img
        ...
        <p className="w-[240px] text-sm text-[#87a0b5] font-semibold">
