...
export function FirstBannerMobile(props: IFirstBannerProps) {
  const dataList = [
    {
  ...
  return (
    <>
      ...
      <div className="text-sm bg-[#203241]  text-white font-bold z-10 text-[27px] flex justify-center flex-col items-center top-5 left-10 gap-1">
        ...
        <button className="text-sm rounded bg-primary text-white w-[150px] py-2">
          Register
        </button>
        <p className="text-xs font-medium">or login with</p>
        <div className="flex gap-2">
      ...
      <div className="flex bg-[#203241] justify-evenly text-[10px] py-4">
